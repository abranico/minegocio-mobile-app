...
interface Props {
  onClose: () => void;
  modalState: boolean;
  handleEditCode: (newCode: Code) => void;
  code: Code;
}
...
export default function EditCode({
  ...
  const [newCodeValue, setNewCode] = useState<Code>(code);
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Editar Código</Text>
